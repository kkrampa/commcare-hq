...
COUCH_DATABASES = {
    'default': {
        ...
        'COUCH_HTTPS': os.getenv('COUCH_HTTPS') == 'true',
        'COUCH_SERVER_ROOT': os.getenv('COUCH_SERVER_ROOT', b'couch:5984'),  # 6984 for https couch
        'COUCH_USERNAME': os.getenv('COUCH_USERNAME', ''),
        'COUCH_PASSWORD': os.getenv('COUCH_PASSWORD', ''),
        'COUCH_DATABASE_NAME': os.getenv('COUCH_DATABASE_NAME', b'commcarehq')
    }
}
...
KAFKA_BROKERS = ['{}:9092'.format(os.getenv('KAFKA_BROKER', 'kafka'))]
...
FORMPLAYER_INTERNAL_AUTH_KEY = os.getenv('FORMPLAYER_INTERNAL_AUTH_KEY', 'secretkey')
LOCAL_APPS = ()
BASE_ADDRESS = os.getenv("BASE_ADDRESS", "localhost:8000")
